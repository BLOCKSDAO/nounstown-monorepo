...
/*
export async function getAuction (auctionHouseProxyAddress: string): Promise<Auction> {
  const auction = await useContractCall<Auction>({
    abi,
...
export const useAuctionMinBidIncPercentage = (auctionHouseProxyAddress: string) => {
