  ...
  return (
    ...
    <div className={classes.wrapper}>
      ...
      <Container fluid="xl" style={{ borderBottomColor: '#a3efd0', borderBottomWidth: 'thin', borderBottomStyle: 'solid', marginBottom: '20px' }}>
	    ...
	    <br />
	    <span style={{ fontStyle: 'italic', fontSize: 'small' }}>Data refreshes every 30 seconds -- if &lt; 5 minutes remaining, data refreshes every 10 seconds. Stats are from last 15 auctions.</span>
	    <br />
	    <br />
      ...
      {trackerConfig.slice().map(tracker => (
	    ...
	    <div className={classes.wrapper}>
	      <Container fluid="xl" style={{ borderBottomColor: '#a3efd0', borderBottomWidth: 'thin', borderBottomStyle: 'solid', marginBottom: '20px' }}>
	          ...
	          <Tracker name={tracker.name} tokenAddress={tracker.tokenAddress} uri={tracker.uri} subgraphApiUri={tracker.subgraphApiUri} />
