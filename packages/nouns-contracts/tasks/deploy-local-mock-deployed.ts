...
import { ContractNameDeployed } from './types';

type LocalContractName = ContractNameDeployed | 'WETH';
...
task('deploy-local-mock-deployed', 'Deploy mock deployed contracts to hardhat')
  ...
  .setAction(async (args, { ethers }) => {
    ...
    const contracts: Record<LocalContractName, Contract> = {
      ...
      NounsToken: {
        args: [
          ...
          () => contracts.NounsDescriptorDeployed.instance?.address,
    ...
    for (const [name, contract] of Object.entries(contracts)) {
      ...
      contracts[name as ContractNameDeployed].instance = deployedContract;
